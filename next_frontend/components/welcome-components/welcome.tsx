...
export default function Welcome() {
    ...
    const websiteDescriptionRef = useRef<HTMLHeadingElement>(null)
    const stepsDescriptionRef = useRef<HTMLHeadingElement>(null)
    ...
    const animateSteps = (entries: IntersectionObserverEntry[]) => {
    ...
    return (
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="w-4/5 min-w-[300px] max-w-[1000px]">
                <div
                    className="relative w-full rounded-md right-[150%] animate-left-slide-in"
            ...
            <footer className="text-lg">Made with 💚 in NYC</footer>
